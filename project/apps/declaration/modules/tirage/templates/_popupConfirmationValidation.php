<div class="modal fade" id="tirage-confirmation-validation" role="dialog" aria-labelledby="Confirmation de validation" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Confirmez-vous la validation de la déclaration de tirage ?</p>
                </div>
