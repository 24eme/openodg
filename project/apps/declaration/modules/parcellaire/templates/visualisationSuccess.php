...
<div class="page-header no-border">
    <h2>Visualisation de votre <?php if ($parcellaire->isIntentionCremant()): ?>intention de production<?php else: ?>parcellaire<?php endif; ?><?php echo ($parcellaire->isParcellaireCremant())? ' crémant' : ''; ?> <?php echo $parcellaire->campagne; ?>
