                        ...
                        <tr style="border-bottom: 1px solid #cbcbcb;" >
                            ...
                            <td class="text-center" colspan="2">
                                ...
                                <?php elseif (($constat->statut_raisin == ConstatsClient::STATUT_APPROUVE) && ($constat->statut_volume == ConstatsClient::STATUT_APPROUVE)): ?>
                                    ...
                                    <br/>
                                    <span class="label label-success" >Approuvé</span>&nbsp;<a href="<?php echo url_for('constat_pdf', array('identifiant' => $constat->getDocument()->getCvi(), 'campagne' => $constat->campagne, 'identifiantconstat' => $constat->getKey())) ?>"  class="btn btn-xs btn-default btn-primary-step"><span class="glyphicon glyphicon-file"></span>&nbsp;Visualiser</a>
