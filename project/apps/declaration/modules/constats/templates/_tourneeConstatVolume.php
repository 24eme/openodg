<div id="saisie_constat_volume_{{ keyConstatNode}}" ng-show="active == 'saisie'" class="col-xs-12 print-margin-bottom">
    ...
    <div class="row row-margin">
        <div class="col-xs-12">
            ...
            <div class="col-xs-6">
                <a href="" ng-click="approuverConstatVolume(constat)" class="btn btn-default btn-lg col-xs-6 btn-block btn-upper link-to-section"><span class=" glyphicon glyphicon-ok-circle"></span> Approuver</a>
            </div>
        </div>
    </div>
</div>
