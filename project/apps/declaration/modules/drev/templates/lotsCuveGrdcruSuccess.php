...
<form method="post" action="<?php echo url_for('drev_lots', $drev->addPrelevement(Drev::CUVE_GRDCRU)); ?>" role="form" class="ajaxForm" autocomplete="off">
    <?php if ($hasError): ?>
    ...
    <?php include_partial('drev/lotsForm', array('drev' => $drev, 'form' => $form, 'ajoutForm' => $ajoutForm, 'error_produit' => $error_produit, 'title' => 'Lieux dits – Cépages', "vtsgn_inclus" => true)); ?>
