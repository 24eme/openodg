...
<div class="col-xs-4">
    <div class="block_declaration panel <?php if ($drev && $drev->validation): ?>panel-success<?php else: ?>panel-primary<?php endif; ?>">
        ...
        <?php elseif (!DRevClient::getInstance()->isOpen()): ?>
            ...
            <div class="panel-bottom">
                <?php if ($sf_user->isAdmin()): ?>
                    <p>
                        <a class="btn btn-lg btn-default btn-block" href="<?php echo url_for('drev_create', $etablissement) ?>">Démarrer la télédéclaration</a>
                    </p>
                    <p>
        ...
        <?php else: ?>
            ...
            <div class="panel-bottom">
                <p>
                    <a class="btn btn-lg btn-block btn-default" href="<?php echo url_for('drev_create', $etablissement) ?>">Démarrer la télédéclaration</a>
                </p>
                <?php if ($sf_user->isAdmin()): ?>
                    <p>
