    ...
    <table class="table table-bordered table-striped table-condensed" id="table-revendication">
        <thead>
            ...
            <tr>
                ...
                <th class="text-center info col-xs-1">Volume nets (L15)<br /><small class="text-muted">(hl)</small></th>
                <th class="text-center info col-xs-1">Vendange fraiche<br /><small class="text-muted">(hl)</small></th>
                <th class="text-center info col-xs-1">VCI Constitué (L19)<br /><small class="text-muted">(hl)</small></th>
