<ul class="nav nav-tabs" role="tablist">
    ...
    <?php if($ajoutForm->hasProduits()): ?>
        <li class="text-center"><a role="tab" data-toggle="modal" data-target="#popupAjoutAppellationForm" href="" id="btn-popup"><span class="glyphicon glyphicon-plus-sign"></span></a></li>
    <?php endif; ?>
