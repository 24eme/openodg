    ...
    <div class="col-xs-12">        
        ...
        <table class="table table-striped">
            ...
            <tr>
                ...
                <td>
                    <a href="<?php if($tournee->statut == TourneeClient::STATUT_AFFECTATION): ?><?php echo url_for('degustation_affectation', $tournee); ?><?php elseif(in_array($tournee->statut, array(TourneeClient::STATUT_DEGUSTATIONS, TourneeClient::STATUT_COURRIERS, TourneeClient::STATUT_TERMINE))): ?><?php echo url_for('degustation_degustations', $tournee); ?><?php endif; ?>">Dégustation (<?php if($tournee->nombre_commissions):echo $tournee->nombre_commissions." commissions, " ?><?php endif; ?><?php echo count($tournee->degustateurs->PORTEUR_MEMOIRES)." porteurs de mémoires, ".count($tournee->degustateurs->TECHNICIEN_PRODUIT)." techniciens du produit, ".count($tournee->degustateurs->USAGER_PRODUIT)." usagers du produit)"; ?></a>
