...
<?php use_javascript('tournee.js?201504270331'); ?>
                ...
                <div class="list-group print-list-group-condensed">
                    <a ng-repeat="operateur in operateurs | orderBy: ['position']" href="" ng-click="updateActive(operateur._id)" ng-class="{ 'list-group-item-success': operateur.termine && !operateur.motif_non_prelevement, 'list-group-item-danger': (operateur.has_erreurs), 'list-group-item-warning': operateur.termine && operateur.motif_non_prelevement}" class="list-group-item col-xs-12 link-to-section" style="padding-right: 0; padding-left: 0;">
                        <div class="col-xs-2 col-sm-1 text-left">
                            <strong ng-show="!motifs[operateur.motif_non_prelevement]" class="lead" style="font-weight: bold;">{{ operateur.heure }}</strong>
                            <strong ng-show="motifs[operateur.motif_non_prelevement]" class="lead" style="text-decoration: line-through;">{{ operateur.heure }}</strong>
        ...
        <div class="row">
            <div class="col-xs-12">
                <div style="border-bottom: 0;" class="page-header">
                    ...
                    <span ng-show="!operateur.aucun_prelevement" class="glyphicon glyphicon-unchecked hidden-print" style="font-size: 20px;"></span><span ng-show="operateur.aucun_prelevement" class="glyphicon glyphicon-check hidden-print" style="font-size: 20px;"></span>&nbsp;&nbsp;<strong class="lead text-warning">Aucun prélèvement</strong><span class="ng-hide visible-print-inline lead"> : Report, Plus de vin, Soucis <small><i>(Veuillez entourer la raison)</i></small></span>
                    </a>
                    </h3>
                </div>
            ...
            <div ng-show="!operateur.aucun_prelevement" ng-repeat="(prelevement_key, prelevement) in operateur.prelevements" id="saisie_mission_{{ operateur._id }}_{{ prelevement_key }}" class="col-xs-12 print-margin-bottom">
                        ...
                        <div class="form-horizontal">
                            ...
                            <div class="row">
                                <div class="form-group col-xs-12 col-sm-12 col-md-4 lead" >
                                    <label class="control-label col-xs-5 col-sm-6 col-md-5" for="preleve_{{ operateur._id }}_{{ prelevement_key }}"><strong>N°&nbsp;d'anon.</strong>&nbsp;:</label>
                                ...
                                <div class="form-group col-xs-12 col-sm-6 col-md-4 lead">
                                    <label class="control-label col-xs-5" for="preleve_{{ operateur._id }}_{{ prelevement_key }}"><strong>Vol.&nbsp;<small>(hl)</small></strong>&nbsp;:</label>
                                    <div class="col-xs-7">
