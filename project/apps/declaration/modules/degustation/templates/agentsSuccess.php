...
<div class="row">
    <div class="col-xs-12" style="padding-bottom: 15px;">
        <div class="btn-group">
            ...
            <a data-state="active" data-filter="active" class="btn btn-default nav-filter"  href="">Séléctionné <span class="badge"><?php echo count($tournee->agents) ?></span></a>
        </div>
    </div>
    <div class="col-xs-12">
        <div id="listes_operateurs" class="list-group">
            <?php foreach($agents as $agent): ?>
            <?php $exist = $tournee->agents->exist($agent->_id); ?>
...
<div class="row row-margin row-button">
    <div class="col-xs-6">
        <a href="<?php echo url_for('degustation_degustateurs', $tournee) ?>" class="btn btn-primary btn-lg btn-upper">Précédent</a>
    </div>
