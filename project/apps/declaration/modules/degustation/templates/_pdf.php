...
<p>Madame, Monsieur,</p>
<br/>
<p style="text-align: justify;">Vous avez présenté un échantillon de <strong><?php echo $prelevement->libelle; ?></strong> à une dégustation conseil <?php echo $degustation->libelle ?> organisée par l'ODG-AVA. Celle-ci a eu lieu le <strong><?php echo ucfirst(format_date($degustation->date_degustation, "P", "fr_FR")); ?></strong>.</p>
