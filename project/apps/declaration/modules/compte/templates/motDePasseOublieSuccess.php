...
<div class="row row-margin row-button">
    <div class="col-xs-12 text-right">
        <a class="btn btn-default btn-lg btn-upper" href="<?php echo sprintf("%s?%s", sfConfig::get('app_url_compte_mot_de_passe_oublie'),http_build_query(array('service' => url_for("home", array(), true)))) ?>">
            Mot de passe oublié
