...
<?php echo $doc->key[DeclarationTousView::KEY_TYPE] ?>;<?php echo $doc->key[DeclarationTousView::KEY_CAMPAGNE] ?>;<?php echo $doc->key[DeclarationTousView::KEY_IDENTIFIANT] ?>;"<?php echo sfOutputEscaper::unescape($doc->key[DeclarationTousView::KEY_RAISON_SOCIALE]); ?>";"<?php echo $doc->key[DeclarationTousView::KEY_COMMUNE] ?>";"<?php echo $doc->key[DeclarationTousView::KEY_EMAIL] ?>";<?php echo $doc->key[DeclarationTousView::KEY_DATE] ?>;<?php echo $doc->key[DeclarationTousView::KEY_MODE] ?>;<?php echo $doc->key[DeclarationTousView::KEY_STATUT] ?>;<?php echo $doc->key[DeclarationTousView::KEY_INFOS] ?>;<?php echo $doc->id ?>
