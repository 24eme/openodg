...
<div class="page-header">
    <h2><?php if ($etablissement->needEmailConfirmation()): ?>Confirmation de votre e-mail<?php else: ?>Déclaration de Revendication<?php endif; ?></h2>
</div>
<?php if ($etablissement->needEmailConfirmation()): ?>
