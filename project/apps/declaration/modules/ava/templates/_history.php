...
<?php foreach ($history as $drev): ?>
    ...
    <?php elseif($drev->type == ParcellaireClient::TYPE_MODEL && strpos($drev->_id, ParcellaireClient::TYPE_COUCHDB."-") !== false): ?>
    ...
    <?php elseif($drev->type == ParcellaireClient::TYPE_MODEL && strpos($drev->_id, ParcellaireClient::TYPE_COUCHDB_PARCELLAIRE_CREMANT."-") !== false): ?>
        <a class="list-group-item" href="<?php echo url_for('parcellaire_visualisation', $drev) ?>"><span class="glyphicon glyphicon-file"></span>&nbsp;Affectation parcellaire Crémant <?php echo $drev->campagne ?></a>
    <?php endif; ?>
<?php endforeach; ?>
</div>
<?php endif; ?>
