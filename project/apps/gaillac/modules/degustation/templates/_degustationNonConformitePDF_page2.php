...
<table border="1">
  ...
  <tr>
    <td>
      ...
      <ul>
        <?php if ($lot->isSecondPassage() || $lot->conformite == Lot::CONFORMITE_NONCONFORME_GRAVE || $lot->conformite == Lot::CONFORMITE_NONCONFORME_ETAT || $lot->conformite == Lot::CONFORMITE_NONCONFORME): ?>
        <li>Recours OC/OI</li>
        <?php else: ?>
