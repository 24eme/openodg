...
<table border=0 cellspacing=0 cellpadding=0>
    ...
    <tr class="align-mid">
        ...
        <?php foreach ($lots as $lot) :?>
            <td class="todo <?php if($lot[0] === "empty"): ?>text-muted<?php endif;?>">Bon</td>
            <td class="todo <?php if($lot[0] === "empty"): ?>text-muted<?php endif;?>">Moyen</td>
            <td class="todo <?php if($lot[0] === "empty"): ?>text-muted<?php endif;?>">Fluide</td>
        <?php endforeach; ?>
    </tr>
    <tr class="align-mid">
    ...
    <tr>
        ...
        <?php foreach ($lots as $lot) :?>
            <td class="td align-mid <?php if($lot[0] === "empty"): ?>text-muted<?php endif;?>" colspan="3">OUI&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;LIMITE&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;NON</td>
        <?php endforeach; ?>
    </tr>
    <tr>
