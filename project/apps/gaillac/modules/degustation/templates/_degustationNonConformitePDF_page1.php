...
<table><tr><td><strong>Objet :</strong> Résultats contrôle organoleptique <?php echo $lot->getTextPassage() ?> <strong>non <?php echo $lot->isLibelleAcceptable() ? 'acceptable' : 'conforme'; ?></strong> NC<?php echo $lot->unique_id ?></td></tr></table>
<br/><br/>
