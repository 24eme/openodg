...
<div class="row">
    <div class="col-xs-12">
        ...
        <p>
            <strong>Maison de vins de Gaillac</strong>
            Place de l’Abbaye Saint Michel <br/>
            81600 Gaillac <br/>
            France
        </p>
        <p>
            <strong>Tél.</strong> :  05 63 57 15 40<br />
            <strong>E-mail</strong> : maison@vins-gaillac.com
        </p>
        <p>
