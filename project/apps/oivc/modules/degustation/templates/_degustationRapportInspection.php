    ...
    <tbody>
        ...
        <tr><td>
            <table>
                ...
                <tr>
                    <td></td>
                    <td colspan="3"><?php echoCheck('Suite à contrôle produit ODG non conforme', $lot->initial_type == PMCClient::TYPE_MODEL || $lot->initial_type == PMCNCClient::TYPE_MODEL) ?></td>
                </tr>
                <tr>
                    <td></td>
        ...
        <tr><td>Date du prélèvement : <?php echo DateTimeImmutable::createFromFormat('Y-m-d', $lot->prelevement_datetime)->format('d/m/Y') ?></td></tr>
