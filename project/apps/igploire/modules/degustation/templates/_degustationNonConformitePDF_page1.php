  ...
  <tr><td>
    <ul>
      <?php if ($lot->isSecondPassage() || $lot->conformite == Lot::CONFORMITE_NONCONFORME_MAJEUR): ?>
        <li><strong>Soit de vous opposer aux conclusions de ce contrôle et de demander un reprélèvement du même lot.</strong> Dans ce cas, veuillez nous retourner la fiche jointe dûment complétée. Le dossier sera transmis à l'ASSVAS (organisme d'inspection) sur notre demande ou sous quinzaine à compter de la date du présent courrier. (Frais à votre charge : 52€ HT)<br/>Attention : Durant cette période, votre lot NE peut PAS être commercialisé.</li>
      <?php else: ?>
