...
<!-- ####### PLEASE KEEP ####### -->
    <head>
        ...
        <link rel="shortcut icon" type="image/x-icon" href="/favico_nantes.ico" />
        <link rel="icon" type="image/x-icon" href="/favico_nantes.ico" />
        <link rel="icon" type="image/png" href="/favico_nantes.png" />

        <?php include_stylesheets() ?>

        <link href="https://fonts.googleapis.com/css?family=Open+Sans:400,700,600" rel="stylesheet" type="text/css">
        <link href="/css/style_cheverny.css?201803141452" rel="stylesheet" type="text/css">
