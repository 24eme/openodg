    ...
    <div class="container">
      <div class="row">
        <div class="col-xs-4 col-md-1">
          <div class="logo-site">
            <a href="<?php echo url_for('accueil') ?>"><img style="margin-top: 5px;margin-bottom: 0px;" src="/images/logo_ventoux.png" alt="Logo Ventoux" height="50px"></a>
          </div>
        </div>
                ...
                <?php if($sf_user->isAdminODG()): ?>
                    ...
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><span class="glyphicon glyphicon-stats"></span><span class="caret"></span></a>
                      <ul class="dropdown-menu">
                        <?php foreach(sfConfig::get('app_nav_stats_'.Organisme::getCurrentOrganisme()) as $i => $navItem):
