...
class HabilitationSecurity extends DocumentSecurity implements SecurityInterface {
    ...
    public function isAuthorized($droits) {
        ...
        if(!$this->user->isAdmin() && !$this->user->hasCredential(AppUser::CREDENTIAL_HABILITATION) && $this->user->getCompte() && !preg_match("/^".$this->user->getCompte()->identifiant."/", $this->doc->identifiant)) {
