...
Enfin, l'ensemble de l'historique de vos factures et règlements sont également disponible dans votre espace de facturation : <?php echo ProjectConfiguration::getAppRouting()->generate('facturation_declarant', array("id" => explode("-", $id)[1]), true); ?>
