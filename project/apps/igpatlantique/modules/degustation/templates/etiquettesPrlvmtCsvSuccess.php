numero_dossier;numero_lot;declarant_nom;cvi;siret;"numero interne";code_postal;ville;produit_libelle;millesime;details;centilisation;numero_logement_operateur;volume;"numero_anonymat";logement;adresse opérateur;téléphone opérateur;email;adresse logement;
<?php
...
foreach ($degustation->getEtiquettesFromLots(7) as $plancheLots) {
    foreach($plancheLots as $lotInfo) {
        ...
        echo str_replace(';', ' ', $lotInfo->lot->adresse_logement).";";
        echo "\n";
    }
}
