      ...
      <?php if ($table_header): $table_header = false; ?>
          <table border="1px" class="table" cellspacing=0 cellpadding=0 style="text-align: center;border-collapse:collapse;" scope="colgroup" >
            <tr style="line-height:20px;">
               ...
               <th class="bg-white" colspan="3"style="width:18%;"><?php echo tdStart() ?><strong>Avis</strong></th>
               <th class="bg-white"  colspan="2"style="width:12%;"><?php echo tdStart() ?><strong>Typicité cépage</strong></th>
            ...
            <tr style="line-height:13px;">
              ...
              <th class="bg-white" style="width:6%;"><?php echo tdStart() ?><strong><small>NCNR</small></strong></th>
              <th class="bg-white" style="width:6%;"><?php echo tdStart() ?><strong><small>NCR</small></strong></th>
              <th class="bg-white" style="width:6%;"><?php echo tdStart() ?><strong><small>C</small></strong></th>
              <th class="bg-white" style="width:6%;"><?php echo tdStart() ?><strong><small>NC</small></strong></th>
              <th class="empty bg-white"></th>
            </tr>
      <?php endif; ?>
