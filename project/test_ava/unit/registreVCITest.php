...
$t->is($registre->mouvements[1]->stock_resultant, 0, 'stock enregistré dans le mouvemnt');
$t->is($registre->mouvements[1]->date, ($registre->campagne + 1).'-12-31', 'date du mouvement à la date de dépot de la DR');
...
$t->is($registre->mouvements[2]->date, $registre->campagne.'-10-15', 'date du mouvement à la date de la fin de l\'année suivante');
