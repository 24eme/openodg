...
<section id="content" class="container">
	...
	<div class="row">
		<div class="col-sm-6 first-connection">
			<div class="row">
		...
		<div class="col-sm-6 space-member">
				...
				<div class="col-sm-10 col-sm-offset-1">
					...
					<form class="form-horizontal" action="#" method="post" role="form">
						<div class="form-group">
							<label class="col-sm-4 control-label" for="login">Identifiant :</label>
							<div class="col-sm-8">
	...
	<div class="presentation-services">
		<div class="row">
			<div class="col-sm-12 presentation-title">
