...
(function ($)
{
    ...
    $.initBsSwitchCheckbox = function ()
    {
        ...
        $.fn.onoff = function (event, state) {
            if (state) {
                ...
                $(this).trigger('update');
                $(this)[0].dispatchEvent(new Event('change-native'));
            } else {
	...
	$('#btn-validation-document').attr('type', 'button');
        ...
        $('#btn-validation-document').click(function() {
            ...
            if(!document.getElementById("notNeedToEngage")){
    ...
    $.initHabilitation = function() {
      ...
      $('.open-button').click(function(){
        if($(this).css('opacity') == "1"){
          ...
          table.find('tr:hidden').each(function(){
            $(this).show();
          });
          ...
          table.find('td[data-hide="1"]').each(function(){
            $(this).hide();
          });
