...
if os.path.exists(sys.argv[2]+"/dr.csv") and os.path.getsize(sys.argv[2]+"/dr.csv"):
    ...
    csv = pd.read_csv(sys.argv[2]+"/dr.csv", encoding='iso-8859-1', delimiter=";", decimal=",", index_col=False, dtype={'CVI': 'str', 'CVI Tiers': 'str', 'Millesime':'str'})
...
if os.path.exists(sys.argv[2]+"/sv12.csv") and os.path.getsize(sys.argv[2]+"/sv12.csv"):
    ...
    csv = pd.read_csv(sys.argv[2]+"/sv12.csv", encoding='iso-8859-1', delimiter=";", decimal=",", index_col=False, dtype={'CVI': 'str', 'CVI Tiers': 'str', 'Millesime':'str'})
    csv['CVI'] = csv['CVI'].zfill(10)
    csv['CVI Tiers'] = csv['CVI Tiers'].zfill(10)
...
if os.path.exists(sys.argv[2]+"/sv11.csv") and os.path.getsize(sys.argv[2]+"/sv11.csv"):
    ...
    csv = pd.read_csv(sys.argv[2]+"/sv11.csv", encoding='iso-8859-1', delimiter=";", decimal=",", index_col=False, dtype={'CVI': 'str', 'CVI Tiers': 'str', 'Millesime':'str'})
    csv['CVI'] = csv['CVI'].zfill(10)
    csv['CVI Tiers'] = csv['CVI Tiers'].zfill(10)
...
if os.path.exists(sys.argv[2]+"/production.csv") and os.path.getsize(sys.argv[2]+"/production.csv"):
    ...
    csv = pd.read_csv(sys.argv[2]+"/production.csv", encoding='iso-8859-1', delimiter=";", decimal=",", index_col=False, dtype={'CVI': 'str', 'CVI Tiers': 'str', 'Millesime':'str'})
    csv['CVI'] = csv['CVI'].zfill(10)
    csv['CVI Tiers'] = csv['CVI Tiers'].zfill(10)
