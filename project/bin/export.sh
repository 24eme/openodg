...
cat $EXPORTDIR/declarations_cepages_lots.csv.part | sed 's/ALICANTE HENRI/ALICANTE HENRI/g' | sed 's/ALICANTE HENRI BOUSCHET N,GRENACHE N/ALICANTE HENRI BOUSCHET N,GRENACHE N/g' | sed 's/ALIGOTÉ B/ALIGOTÉ B/g' | sed 's/ARINARNOA N/ARINARNOA N/g' | sed 's/CABERNET FRANC N/CABERNET FRANC N/g' | sed 's/CABERNET FRANC N/CABERNET FRANC N/g' | sed 's/CABERNET SAUVIGNON N/CABERNET SAUVIGNON N/g' | sed 's/CABERNET SAUVIGNON N/CABERNET SAUVIGNON N/g' | sed 's/CAB-SAUV-N/CAB-SAUV-N/g' | sed 's/CALADOC N/CALADOC N/g' | sed 's/CALADOC N/CALADOC N/g' | sed 's/CAMENÈRE N/CAMENÈRE N/g' | sed 's/CARIGNAN N/CARIGNAN N/g' | sed 's/CARIGNAN N/CARIGNAN N/g' | sed 's/CHARDONNAY B/CHARDONNAY B/g' | sed 's/CHARDONNAY B/CHARDONNAY B/g' | sed 's/CHARDONNAY,SAUVIGNON/CHARDONNAY,SAUVIGNON/g' | sed 's/CHARDONNAY B/CHARDONNAY B/g' | sed 's/CHASAN B/CHASAN B/g' | sed 's/CHASAN B/CHASAN B/g' | sed 's/CINSAULT,GRENACHE/CINSAULT,GRENACHE/g' | sed 's/CINSAULT N/CINSAULT N/g' | sed 's/CINSAULT N,GRENACHE N,CARIGNAN N/CINSAULT N,GRENACHE N,CARIGNAN N/g' | sed 's/CINSAULT N/CINSAULT N/g' | sed 's/CLAIRETTE B/CLAIRETTE B/g' | sed 's/CLAIRETTE B/CLAIRETTE B/g' | sed 's/COLOMBARD B/COLOMBARD B/g' | sed 's/COT N/COT N/g' | sed 's/COUNOISE N/COUNOISE N/g' | sed 's/COUNOISE N/COUNOISE N/g' | sed 's/GAMAY N/GAMAY N/g' | sed 's/GRENACHE N/GRENACHE N/g' | sed 's/GRENACHE BLANC B/GRENACHE BLANC B/g' | sed 's/GRENACHE BLANC B/GRENACHE BLANC B/g' | sed 's/GRENACHE,CINSAULT/GRENACHE,CINSAULT/g' | sed 's/GRENACHE GRIS G/GRENACHE GRIS G/g' | sed 's/GRENACHE,MARSELAN,CALADOC,SYRAH/GRENACHE,MARSELAN,CALADOC,SYRAH/g' | sed 's/GRENACHE N/GRENACHE N/g' | sed 's/GRENACHE N/GRENACHE N/g' | sed 's/GRENACHE N/GRENACHE N/g' | sed 's/GRENACHE N,CINSAUT N/GRENACHE N,CINSAUT N/g' | sed 's/GRENACHE N,SYRAH N/GRENACHE N,SYRAH N/g' | sed 's/MARSANNE B/MARSANNE B/g' | sed 's/MARSANNE B/MARSANNE B/g' | sed 's/MARSELAN N/MARSELAN N/g' | sed 's/MARSELAN N/MARSELAN N/g' | sed 's/MARSELAN N/MARSELAN N/g' | sed 's/MERLOT/MERLOT/g' | sed 's/MERLOT N/MERLOT N/g' | sed 's/MERLOT N/MERLOT N/g' | sed 's/MERLOT N,TEMPRANILLO N/MERLOT N,TEMPRANILLO N/g' | sed 's/MOURVED N/MOURVED N/g' | sed 's/MOURVEDRE N/MOURVEDRE N/g' | sed 's/MOURVEDRE N/MOURVEDRE N/g' | sed 's/MUSCAT À PETITS GRAINS B/MUSCAT À PETITS GRAINS B/g' | sed 's/MUSCAT À PETITS GRAINS B/MUSCAT À PETITS GRAINS B/g' | sed 's/MUSCAT À PETITS GRAINS B/MUSCAT À PETITS GRAINS B/g' | sed 's/MUSCAT DE HAMBOURG N/MUSCAT DE HAMBOURG N/g' | sed 's/MUSCAT PG B/MUSCAT PG B/g' | sed 's/MUS HAMB N/MUS HAMB N/g' | sed 's/MUS P G RS/MUS P G RS/g' | sed 's/MUS PT G B/MUS PT G B/g' | sed 's/NIELLUCCIO N/NIELLUCCIO N/g' | sed 's/PETIT VERDOT N/PETIT VERDOT N/g' | sed 's/PINOT/PINOT/g' | sed 's/PINOT NOIR N/PINOT NOIR N/g' | sed 's/PINOT NOIR N/PINOT NOIR N/g' | sed 's/PIQUEPOUL BLANC B/PIQUEPOUL BLANC B/g' | sed 's/ROSÉ DU VAR RS/ROSÉ DU VAR RS/g' | sed 's/ROUSSANNE B/ROUSSANNE B/g' | sed 's/ROUSSANNE B/ROUSSANNE B/g' | sed 's/SAUVIGNON B/SAUVIGNON B/g' | sed 's/SAUVIGNON B/SAUVIGNON B/g' | sed 's/SAUVIGNON B/SAUVIGNON B/g' | sed 's/SAUVIGNON B/SAUVIGNON B/g' | sed 's/SEMILLON B/SEMILLON B/g' | sed 's/SYRAH/SYRAH/g' | sed 's/SYRAH N/SYRAH N/g' | sed 's/SYRAH N/SYRAH N/g' | sed 's/TANNAT N/TANNAT N/g' | sed 's/TEMPRANILLO N/TEMPRANILLO N/g' | sed 's/TIBOUREN N/TIBOUREN N/g' | sed 's/UGNI BLANC B/UGNI BLANC B/g' | sed 's/UGNI BLANC B/UGNI BLANC B/g' | sed 's/VERMENT B/VERMENT B/g' | sed 's/VERMENTINO B/VERMENTINO B/g' | sed 's/VERMENTINO B/VERMENTINO B/g' | sed 's/VIOGNIER B/VIOGNIER B/g' | sed 's/VIOGNIER B/VIOGNIER B/g' | sed 's/VIOGNIER B/VIOGNIER B/g' | sed 's/VIOGNIER,CHARDONNAY/VIOGNIER,CHARDONNAY/g' > $EXPORTDIR/declarations_lots.csv.part
