...
join -t ';' -a 1 -1 36 -2 1 $EXPORTDIR/lots_cleancepages.csv.part.sorted  $EXPORTDIR/lots-passages.csv | awk -F ';' 'OFS=";" {$1=""; print $0}' | sed 's/^;//'  >> $EXPORTDIR/lots_cleancepages_passages.csv.part
