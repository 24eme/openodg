...
# j'ai commenté l'import car il y a un problème avec le schema des mouvement de lots dans une DREV car certains comporte le champs numero_cuve et d'autres non or j'identifie la DREV en question pour une Degustation
# par le numéro de cuve il y a donc des erreurs ça serait bien d'identifié la DREV d'une Degustation grace à la campagne, numéro de dossier et numéro de lot et non seulement avec le numéro de cuve (ligne 180 de ImportDegustationIATask)
