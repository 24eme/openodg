...
for annee in 2023 2024; do
    ...
    php symfony import:parcellaireaffectation-ventoux --application="$ODG" $DATA_DIR/parcellaire_"$annee".csv

    echo "Import des declarations de pieds manquants"

    php symfony import:parcellairemanquant-ventoux --application="$ODG" $DATA_DIR/parcellaire_"$annee".csv

    echo "Import des declarations de parcellaire irrigué"

    php symfony import:parcellaireirrigue-ventoux --application="$ODG" $DATA_DIR/parcellaire_"$annee".csv
done
