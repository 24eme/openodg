...
$t->ok($lot->getMouvement(Lot::STATUT_CHANGEABLE), "Le lot à un mouvement changeable");
...
$t->ok($drev->lots[0]->getMouvement(Lot::STATUT_CHANGEABLE), "Le lot de la drev d'origine est affectable");
