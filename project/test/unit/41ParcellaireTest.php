...
$parcellaire->addParcelle($configProduit->getHash(), "Grenache", "Les Arcs", "18", "42", null, null);
$parcellaire->save();
...
$t->is($detail->getKey(), "SIRAH-N-AVIGNON-10-52", "La clé de la parcelle est bien construite");
