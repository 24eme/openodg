...
$detail = $parcellaire->addParcelle($configProduit->getHash(), "Sirah N", "2005", $commune, "10", "52", null, null);
$parcellaire->addParcelle($configProduit->getHash(), "Grenache", "2010", "PEYNIER", "18", "42", null, null);
$parcellaire->save();
...
$t->is($detail->getKey(), "SIRAH-N-2005-".$commune."-10-52", "La clé de la parcelle est bien construite");
