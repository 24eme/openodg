...
$principaux = $superficies['CDP']['principaux'];
$secondaires = $superficies['CDP']['secondaires'];
...
$regle1 = $generator->regleNbCepageMin_GetRevendicable($superficies['CDP']['principaux'], 2);
$t->is($regle1, $superficies['CDP']['principaux']['TOTAL'], "Règle 1 OK : 2 au moins des cépages principaux sont présents dans l'encépagement.");

// Test 2 : regle des 90% cépages principaux
$regle2 = $generator->reglePourcentageCepageMax_GetRevendicable($superficies['CDP']['principaux'], $superficies['CDP']['TOTAL'], 90);
$t->is($regle2, $superficies['CDP']['principaux']['TOTAL'], "Règle 2 OK : la proportion d'un des cépages principaux n'est pas supérieure à 90% de l'encépagement");

$regle3 = $generator->regleRatioMax_GetRevendicable($regle2, 30/70, $superficies['CDP']['secondaires']['TOTAL']);
// Test 3 : regle des 70% cepages principaux
$test3 = round(($regle2+$superficies['CDP']['secondaires']['TOTAL']) * 0.7, 4);
...
$test4 = round(($regle2+$superficies['CDP']['secondaires']['TOTAL']) * 0.3, 4);
...
$blancs = ['VERMENTINO B' => $superficies['CDP']['secondaires']['VERMENTINO B'], 'SEMILLON B' => $superficies['CDP']['secondaires']['SEMILLON B'], 'CLAIRETTE B' => $superficies['CDP']['secondaires']['CLAIRETTE B'], 'UGNI BLANC B' => $superficies['CDP']['secondaires']['UGNI BLANC B']];
...
$revendicables = $generator->getRevendicables($superficies);
...
$t->is_deeply($revendicables['CDP'], $result, "Règle 7 : Calcul du potentiel de production OK.");