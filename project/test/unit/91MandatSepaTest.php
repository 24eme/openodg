...
$societe = SocieteClient::getInstance()->createSociete("Chateau 24ème", SocieteClient::TYPE_OPERATEUR);
$societe->siege->adresse = "2 place Sainte Opportune";
$societe->siege->code_postal = "75001";
$societe->siege->commune = "Paris";
