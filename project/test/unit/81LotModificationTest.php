...
$lot->volume += 10;
$lot->produit_hash = $produitconfig2->getHash();
$lot->numero_logement_operateur = "A";
$lot->millesime = "2021";
$lot->destination_type = DRevClient::LOT_DESTINATION_VRAC_FRANCE;
$lot->destination_date = date('Y-m-d');
$lot->specificite = 'bio';
$lot->cepages = array('CHENIN' => 11);
...
$t->is($lotDrevM01->produit_hash, $lot->produit_hash,"Le produit de la drev modificatrice a évolué");
$t->is($lotDrevM01->cepages->toArray(true, false), $lot->cepages->toArray(true, false),"Le cépage de la drev modificatrice a évolué");
$t->is($lotDrevM01->numero_logement_operateur, $lot->numero_logement_operateur,"Le numéro de logement de la drev modificatrice a évolué");
$t->is($lotDrevM01->millesime, $lot->millesime,"Le millésime de la drev modificatrice a évolué");
$t->is($lotDrevM01->destination_type, $lot->destination_type,"La destination type de la drev modificatrice a évolué");
$t->is($lotDrevM01->destination_date, $lot->destination_date,"La date de destination de la drev modificatrice a évolué");
$t->is($lotDrevM01->specificite, $lot->specificite,"La specificité de la drev modificatrice a évolué");
...
$t->is($lotDegustation->produit_hash, $lot->produit_hash,"Le produit de la dégustation a évolué");
$t->is($lotDegustation->cepages->toArray(true, false), $lot->cepages->toArray(true, false),"Les cépage de la dégustation a évolué");
$t->is($lotDegustation->numero_logement_operateur, $lot->numero_logement_operateur,"Le numéro de logement de la dégustation a évolué");
$t->is($lotDegustation->millesime, $lot->millesime,"Le millésime de la dégustation a évolué");
$t->is($lotDegustation->destination_type, $lot->destination_type,"La destination type de la dégustation a évolué");
$t->is($lotDegustation->destination_date, $lot->destination_date,"La date de destination de la dégustation a évolué");
$t->is($lotDegustation->specificite, $lot->specificite,"La specificité de la dégustation a évolué");
