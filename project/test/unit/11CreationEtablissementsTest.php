...
$compteviti->save();
$t->is($compteviti->tags->automatique->toArray(true, false), array('societe', 'operateur', 'producteur', 'etablissement'), "Création d'un etablissement viti met à jour le compte");
...
$comptenego->save();
$t->is($comptenego->tags->automatique->toArray(true, false), array('societe', 'operateur', 'negociant', 'etablissement'), "Création d'un etablissement nego met à jour le compte");
...
$comptenego->addTag('test', 'test');
$comptenego->save();
$t->is($comptenego->tags->automatique->toArray(true, false), array('societe', 'operateur', 'negociant', 'etablissement'), "Création d'un etablissement nego 2 met à jour le compte");
...
$t->is($comptenego_horsregion->tags->automatique->toArray(true, false), array('societe', 'operateur', 'negociant', 'etablissement'), "Création d'un etablissement nego_horsregion met à jour le compte");
...
$comptecoop->save();
$t->is($comptecoop->tags->automatique->toArray(true, false), array('societe', 'operateur', 'cooperative', 'etablissement'), "Création d'un etablissement coop met à jour le compte");
