...
$numero_ordre_key = "00";
$parcelle = $parcellaire->addParcelleWithProduit($produit->getHash(), "Sirah N", "2005", $commune, "", "AB", "52", "LA HAUT");
$parcellaire->addParcelleWithProduit($produit->getHash(), "Grenache", "2010", "PEYNIER", "", "AK", "47", null);
$parcellaire->addParcelleWithProduit($produit->getHash(), "Sirah N", "2005", $commune, "", "AB", "52", "LA HAUT",25);
$parcellaire->addParcelleWithProduit($produit->getHash(), "Sirah N", "2005", $commune, "", "AB", "52", "LA HAUT",26);
$parcellaire->save();
