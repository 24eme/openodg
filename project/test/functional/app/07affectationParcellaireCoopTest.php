...
$numero_ordre_key = "00";
$parcelle = $parcellaire->addParcelle($produit->getHash(), "Sirah N", "2005", $commune, "", "AB", "52", "LA HAUT");
$parcellaire->addParcelle($produit->getHash(), "Grenache", "2010", "PEYNIER", "", "AK", "47", null);
$parcellaire->addParcelle($produit->getHash(), "Sirah N", "2005", $commune, "", "AB", "52", "LA HAUT",25);
$parcellaire->addParcelle($produit->getHash(), "Sirah N", "2005", $commune, "", "AB", "52", "LA HAUT",26);
$parcellaire->save();
