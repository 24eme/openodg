        ...
        foreach(file($arguments['csv']) as $line) {
            ...
            if ($data[self::CSV_CVI] == $parcellaireTotal['declarant']->cvi) {
                ...
                if (!$found) {
                    ...
                    $parcelle = $parcellaireTotal->addParcelleWithProduit($produit->getHash(), $data[self::CSV_CEPAGE], null, null, $data[self::CSV_NOM_COMMUNE], null, $data[self::CSV_SECTION], $data[self::CSV_NUM_PARCELLE]);
                }
