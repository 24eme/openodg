<?php
/**
 * BaseParcellaireIrriguePiece
 *
 * Base model for ParcellaireIrriguePiece
...
abstract class BaseParcellaireIrriguePiece extends Piece {

    public function configureTree() {
       $this->_root_class_name = 'ParcellaireIrrigue';
       $this->_tree_class_name = 'ParcellaireIrriguePiece';
    }
