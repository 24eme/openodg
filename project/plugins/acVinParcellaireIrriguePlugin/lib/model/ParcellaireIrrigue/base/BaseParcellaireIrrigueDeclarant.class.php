<?php
/**
 * BaseParcellaireIrrigueDeclarant
 * 
 * Base model for ParcellaireIrrigueDeclarant
...
abstract class BaseParcellaireIrrigueDeclarant extends acCouchdbDocumentTree {
                
    public function configureTree() {
       $this->_root_class_name = 'ParcellaireIrrigue';
       $this->_tree_class_name = 'ParcellaireIrrigueDeclarant';
    }
