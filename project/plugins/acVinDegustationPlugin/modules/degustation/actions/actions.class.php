...
class degustationActions extends sfActions {
    ...
    public function executeDegustationPresencePDF(sfWebRequest $request){
      $degustation = $this->getRoute()->getDegustation();

      $this->document = new ExportDegustationPresencePDF($degustation,$this->getRequestParameter('output','pdf'),false);
      $this->document->setPartialFunction(array($this, 'getPartial'));
