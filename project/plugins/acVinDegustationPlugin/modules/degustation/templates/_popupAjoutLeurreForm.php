		...
		<div class="modal-content">
			<form method="post" action="<?php echo $url ?>" role="form" class="form-horizontal">
				...
				<div class="modal-header">
					...
					<h4 class="modal-title" id="myModalLabel">Ajouter un leurre<?php if ($table): echo " à la table ".DegustationClient::getNumeroTableStr($table); endif ?></h4>
				</div>
				<div class="modal-body">
					<span class="error"><?php echo $form['hashref']->renderError() ?></span>
					<div class="form-group row">
						<div class="col-xs-10 col-xs-offset-1">
							<?php echo $form['hashref']->render(array("data-placeholder" => "Sélectionnez un produit", "class" => "form-control select2 select2-offscreen", "required" => true)) ?>
						</div>
					</div>
					<div class="form-group row">
