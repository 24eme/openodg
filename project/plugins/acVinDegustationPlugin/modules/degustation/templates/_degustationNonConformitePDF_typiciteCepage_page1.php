...
<table>
  ...
  <br/>
  <tr><td>Lors de la séance de dégustation du <strong><?php echo format_date($degustation->date, "P", "fr_FR"); ?></strong>, le lot <?php showProduitCepagesLot($lot, false) ?> a fait l'objet d'une absence de typicité cépage revendiqué.</td></tr>
  <tr><td>Compte tenu de ce résultat, vous pouvez décider :</td></tr><br/>
  <tr><td>
    <ul>
      <li>Soit d'abandonner la mention cépage sur votre étiquette et commercialiser votre vin en appellation générique (sans mention de cépage);</li><br/>
