...
<div class="page-header no-border">
    <h2>Commission<?php if (DegustationConfiguration::getInstance()->isDegustationExternalisee()) {echo ' externe';} ?></h2>
</div>

<div class="panel panel-default" style="min-height: 160px">
    <div class="panel-heading">
        <h2 class="panel-title">Documents nécessaires à l'organisation d'une commission<?php if (DegustationConfiguration::getInstance()->isDegustationExternalisee()) {echo ' externe';} ?></h2>
    </div>
    <div class="panel-body">
        ...
        <ul class="list-group">
            ...
            <?php if (DegustationConfiguration::getInstance()->isDegustationExternalisee()): ?>
                <li class="list-group-item">
                    <a id="btn_csv_lots_prestataire" href=""><span class="glyphicon glyphicon-list"></span>&nbsp;Tableur des lots pour le prestataire</a>
                </li>
            <?php endif;?>
        </ul>
    </div>
