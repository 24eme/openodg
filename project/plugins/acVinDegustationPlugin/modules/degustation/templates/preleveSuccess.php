...
<form action="<?php echo url_for("degustation_preleve", $degustation) ?><?php if($differer): ?>?differer=1<?php endif; ?>" method="post" class="ajaxForm form-horizontal degustation prelevements">
	...
	<div class="row row-margin row-button">
        <div class="col-xs-4"><a href="<?php if(DegustationConfiguration::getInstance()->isTourneesParSecteur()): echo url_for("degustation_tournees_etape", $degustation); else: echo url_for("degustation_prelevements_etape", $degustation); endif; ?>" class="btn btn-default btn-upper"><span class="glyphicon glyphicon-chevron-left"></span> Retour</a></div>
