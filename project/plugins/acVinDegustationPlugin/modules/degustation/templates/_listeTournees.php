...
<?php foreach($tournees as $d): ?>
    ...
    <tr>
        ...
        <td class="text-right">
            <a style="padding-left: 15px;padding-right: 15px;" href="<?php echo url_for('degustation_visualisation', $d)?>"class="btn btn-xs btn-sm btn-default btn-block"><?= ($d->etape)? DegustationEtapes::$libelles_short[$d->etape] : 'Lots'  ?></a>
        </td>
    </tr>
<?php endforeach; ?>
<tbody>
