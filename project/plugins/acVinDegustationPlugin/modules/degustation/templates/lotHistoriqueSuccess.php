            ...
            <tr>
              ...
              <td class="text-right">
                 ...
                 <?php elseif ($mouvement->value->statut == Lot::STATUT_AFFECTABLE): ?>
                       ...
                       <li><a class="dropdown-item" href="<?php echo url_for('drev_lot_delete_modificative', array('id' => $mouvement->value->document_id, 'unique_id' => $mouvement->value->lot_unique_id)) ?>" onclick="return confirm('Confirmez vous la suppression définitive de ce lot ?')">Supprimer ce lot</a></li>
                       <li><a class="dropdown-item" href="<?php echo url_for('degustation_affectation_lot', array('id' => $mouvement->value->declarant_identifiant, 'unique_id' => $mouvement->value->lot_unique_id)) ?>">Affecter à une dégustation</a></li>
