...
<div class="row" style="padding-top: 30px; padding-bottom: 50px;">
  <div class="col-md-4 col-md-offset-4">
      <ul style="list-style-type:none;">
          <li style="padding-bottom: 10px;"><a id="btn_pdf_fiche_tournee_prelevement" href="<?php echo url_for('degustation_fiche_lots_a_prelever_pdf', array('sf_subject' => $degustation, 'secteur' => $secteur)) ?>"><span class="glyphicon glyphicon-file"></span>&nbsp;Fiche tournée</a></li>
          <li style="padding-bottom: 10px;"><a id="btn_pdf_fiche_individuelle_lots_a_prelever" href="<?php echo url_for('degustation_fiche_individuelle_lots_a_prelever_pdf', array('sf_subject' => $degustation, 'secteur' => $secteur)) ?>"><span class="glyphicon glyphicon-file"></span>&nbsp;Fiche de prélèvements</a></li>
          ...
          <li style="padding-bottom: 10px;"><a id="btn_csv_etiquette" href="<?php echo url_for('degustation_etiquette_csv', $degustation) ?>?labo=1<?php // cosmetique ?>"><span class="glyphicon glyphicon-list"></span>&nbsp;Tableur pour labo</a></li>
      </ul>
  </div>
</div>
