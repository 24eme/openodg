        ...
        <div class="row">
          ...
          <div class="col-xs-12">
              ...
              <?php if(DegustationConfiguration::getInstance()->hasAnonymat4labo()) : ?>
                  <a href="<?php echo url_for('degustation_etiquette_pdf', ['id' => $degustation, 'anonymat4labo' => true]) ?>" class="btn btn-default btn-xs"><span class="glyphicon glyphicon-file"></span>&nbsp;Étiquettes de prélèvement (avec anonymat labo)</a>
              <?php else : ?>
