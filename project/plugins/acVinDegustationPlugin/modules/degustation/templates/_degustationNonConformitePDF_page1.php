...
<table><tr><td><strong>Objet :</strong> Résultats contrôles organoleptiques <?php echo $lot->getTextPassage() ?> <strong>non conformes</strong> lot <?php echo $lot->unique_id ?></td></tr></table>
<br/><br/>
