<?php use_javascript("degustation_ava.js?201601261522", "last") ?>
        ...
        <div class="col-xs-12">
            <div id="listes_operateurs" class="list-group">
                ...
                <div <?php if($exist): ?>data-state="active"<?php endif; ?> class="list-group-item list-group-item-item col-xs-12 <?php if(!$exist): ?>clickable<?php else: ?>list-group-item-success<?php endif; ?>">
                    ...
                    <div class="col-xs-5"><?php echo Anonymization::hideIfNeeded($degustateur->nom_a_afficher) ?> <small class="text-muted">à <?php echo $degustateur->commune ?></small></div>
