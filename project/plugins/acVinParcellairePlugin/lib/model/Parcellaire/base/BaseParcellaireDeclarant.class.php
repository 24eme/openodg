<?php
/**
 * BaseParcellaireDeclarant
 * 
 * Base model for ParcellaireDeclarant
...
abstract class BaseParcellaireDeclarant extends acCouchdbDocumentTree {
                
    public function configureTree() {
       $this->_root_class_name = 'Parcellaire';
       $this->_tree_class_name = 'ParcellaireDeclarant';
    }
