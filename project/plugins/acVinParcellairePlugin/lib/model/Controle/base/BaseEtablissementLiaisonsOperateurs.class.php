 ...
 * @property string $cvi
 * @property string $ppm
 * @property string $hash_chai
 * @property acCouchdbJson $attributs_chai
 ...
 * @method string getHashChai()
 * @method string setHashChai()
 * @method acCouchdbJson getAttributsChai()
 * @method acCouchdbJson setAttributsChai()
