...
<table class="table table-bordered table-condensed table-striped tableParcellaire">
  <thead>
    <tr>
        ...
        <th class="col-xs-8">Cépages autorisés <small class="text-muted">(hors <abbr title="à partir de la campagne <?php echo ParcellaireConfiguration::getInstance()->getCampagneJeunesVignes(); ?>">jeunes vignes</abbr>)</small></th>
