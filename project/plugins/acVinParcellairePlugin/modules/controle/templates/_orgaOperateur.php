<h3 class="mt-0"><RouterLink class="btn btn-sm btn-default" :to="{ name: 'operateurs' }"><span class="glyphicon glyphicon-chevron-left"></span></RouterLink> {{ controleCourant.declarant.nom }} - Sélection des parcelles</h3>
<hr class="mt-2 mb-4" />
<div style="position: relative;">
    ...
    <div v-for="parcelle in parcelles" :id="parcelle.id" class="hidden bloc_parcelle" style="position: absolute; bottom: 0; z-index: 10000; background: white; opacity: 0.9;">
        ...
        <tbody>
            ...
            <tr><th>Sélectionner</th><td v-for="p in parcelle.properties.parcellaires" class="text-center"><label class="switch"><input class="selectParcelle" type="checkbox" v-model="parcellesSelectionnees" :value="p.parcelle_id" /><span class="slider round"></span></label></td></tr>
        </tbody>
        </table>
    </div>
</div>
