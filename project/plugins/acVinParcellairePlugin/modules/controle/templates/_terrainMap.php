<h3 class="mt-0"><span class="">Carte</span><RouterLink :to="{ name: 'listing' }" class="pull-right"><span class="glyphicon glyphicon-remove"></span></RouterLink> <span class="pull-right mr-3" :class="$root.isSynchro ? 'glyphicon glyphicon-floppy-saved' : 'glyphicon glyphicon-floppy-remove'" :style="$root.isSynchro ? 'color: #8da42a;' : 'color: #dddddd'"></span><button class="btn btn-default btn-sm pull-right mr-4" @click="downloadKml">Télécharger KML</button></h3>
<hr class="mt-2 mb-4" />
