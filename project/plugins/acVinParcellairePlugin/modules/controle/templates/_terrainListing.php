<h3 class="mt-0"><span class="glyphicon glyphicon-th-list"></span> Tournée du {{ date_tournee }} <span :class="$root.isSynchro ? 'glyphicon glyphicon-floppy-saved' : 'glyphicon glyphicon-floppy-remove'"></span> <RouterLink :to="{ name: 'map' }" class="pull-right"><span class="glyphicon glyphicon-map-marker"></span></RouterLink></h3>
<hr class="mt-2" />
