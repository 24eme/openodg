...
class ArchivageAllView extends acCouchdbView
{
    ...
    public function getDocsByTypeAndCampagne($type, $campagne, $fourchette_basse = 0, $fourchette_haute = 99999, $format = "%05d") {
    ...
    protected function getViewByTypeAndCampagne($type, $campagne, $fourchette_basse = 0, $fourchette_haute = 99999, $format = "%05d") {
