...
class bsWidgetFormSelectCheckbox extends sfWidgetFormSelectCheckbox {
    ...
    protected function formatChoices($name, $value, $choices, $attributes)
    {
        ...
        foreach ($choices as $key => $option)
        {
          ...
          $inputs[$id] = $this->renderContentTag('label', $this->renderTag('input', array_merge($baseAttributes, $attributes)). '&nbsp;' . $option, array('for' => $id, 'class' => 'btn btn-default btn-sm '.$class));
        }
