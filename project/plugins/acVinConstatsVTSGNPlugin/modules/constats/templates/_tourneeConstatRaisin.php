<div id="saisie_constat_raisin_{{ keyConstatNode}}" ng-show="active == 'saisie'" class="col-xs-12 print-margin-bottom">
    <div class="form-horizontal">
        ...
        <div class="form-group">
            ...
            <div class="col-xs-6">
                <input placeholder="Nombre" id="nb_contenant_{{ keyConstatNode}}" ng-model="constat.nb_contenant" type="number" lang="en" class="form-control input-lg" ng-keydown="blurOnEnter($event)" ng-blur="blur()" />
            </div>
            <div class="col-xs-6">
        ...
        <div class="form-group">
            ...
            <div class="col-xs-6">
                <input placeholder="Degré potentiel" id="degre_potentiel_raisin_{{ keyConstatNode}}" ng-model="constat.degre_potentiel_raisin" type="number" lang="en" class="form-control input-lg" ng-keydown="blurOnEnter($event)" ng-blur="blur()" min="10" max="32" />
            </div>
