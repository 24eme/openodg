...
<?php use_javascript('tournee_vtsgn.js?202011091617'); ?>
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <div class="list-group">
                            <a href="" ng-click="showConstat(constat)" ng-class="{ 'list-group-item-success': ((constat.statut_raisin == '<?php echo ConstatsClient::STATUT_APPROUVE ?>' && constat.type_constat == 'raisin') || (constat.type_constat == 'volume' && constat.statut_volume == '<?php echo ConstatsClient::STATUT_APPROUVE ?>')), 'list-group-item-danger': ((constat.statut_raisin == '<?php echo ConstatsClient::STATUT_REFUSE ?>' && constat.type_constat == 'raisin') || (constat.type_constat == 'volume' && constat.statut_volume == '<?php echo ConstatsClient::STATUT_REFUSE ?>' && constat.raison_refus != '<?php echo ConstatsClient::RAISON_REFUS_ASSEMBLE ?>')), 'list-group-item-warning': (constat.type_constat == 'volume' && constat.statut_volume == '<?php echo ConstatsClient::STATUT_REFUSE ?>' && constat.raison_refus == '<?php echo ConstatsClient::RAISON_REFUS_ASSEMBLE ?>'), 'hidden': (constat.type_constat == 'volume' && constat.statut_raisin != '<?php echo ConstatsClient::STATUT_APPROUVE ?>') }" class="list-group-item" ng-repeat="(keyConstatNode,constat) in constatRdv['constats']">
