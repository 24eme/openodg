...
<form id="ajoutApporteurForm" action="" method="post" class="form-horizontal">
    ...
    <div class="row row-margin row-button">
        <div class="col-xs-4"><a href="<?php echo url_for("parcellaireaffectationcoop_apporteurs", array('id' => $parcellaireAffectationCoop)); ?>" class="btn btn-default"><span class="glyphicon glyphicon-chevron-left"></span> Retour</a></div>
