...
<div class="col-sm-6 col-md-4 col-xs-12">
    <div class="block_declaration panel <?php if($parcellaireAffectationCoop): ?>panel-primary<?php else: ?>panel-default<?php endif; ?>">
        <div class="panel-heading">
            <h3 class="panel-title">Déclarations de vos apporteurs <?php echo $periode ?></h3>
        </div>
        <div class="panel-body">
            <p class="explications">Vous pouvez déclarer les déclarations de vos apporteurs (Affectation, Manquant et Irrigation).</p>
            <div class="actions">
