<ol class="breadcrumb">
  ...
  <li><a href="<?php echo url_for('declaration_etablissement', array('identifiant' => $parcellaireIntentionAffectation->identifiant, 'campagne' => ($parcellaireIntentionAffectation->periode - 1). '-'.$parcellaireIntentionAffectation->periode)); ?>">
