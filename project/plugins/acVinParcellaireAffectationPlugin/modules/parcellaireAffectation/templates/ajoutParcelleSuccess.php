        ...
        <div class="modal-content">
            <form method="post" action="" role="form" class="form-horizontal" novalidate="novalidate">
                ...
                <div class="modal-footer">
                    <a href="<?php echo url_for("parcellaire_affectation_parcelles", array('id' => $parcellaire->_id, 'appellation' => $appellation)) ?>" class="btn btn-danger btn pull-left">Annuler</a>
