    ...
    <div class="panel panel-primary" >
        <div class="panel-body">
            ...
            <form action="<?php echo url_for('parcellaire_affectation_infos_modification', array('identifiant' => 'XXXXXX')) ?>" method="post" class="form-horizontal" id="parcellaire_infos_modification" style="display: none;" >
                <div class="row">
                    <div class="col-xs-8">
                        <div class="form-group">
