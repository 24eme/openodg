        ...
        <div class="modal-content">
            <form method="post" action="<?php echo $url ?>" role="form" class="form-horizontal">
                ...
                <div class="modal-header">
                    ...
                    <h2 class="modal-title" id="myModalLabel">Ajouter une parcelle&nbsp;<?php echo (isset($appellation) && $appellation == ParcellaireAffectationClient::APPELLATION_VTSGN)? 'd\'AOC Alsace blanc' : '';  ?></h2>
                </div>
