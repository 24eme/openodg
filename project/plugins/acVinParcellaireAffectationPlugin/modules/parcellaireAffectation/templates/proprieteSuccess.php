...
<h4></h4>
<br/>
<form action="<?php echo url_for("parcellaire_affectation_propriete", $parcellaire) ?>" method="post" class="form-horizontal ajaxForm">
    ...
    <div class="row row-margin row-button">
        <div class="col-xs-6"><a href="<?php echo url_for("parcellaire_affectation_exploitation", $parcellaire) ?>" class="btn btn-primary btn-lg btn-upper"><span class="eleganticon arrow_carrot-left"></span>&nbsp;&nbsp;Précédent</a></div>
