...
<form action="<?php echo url_for("parcellaire_affectation_acheteurs", $parcellaire) ?>" method="post" class="ajaxForm">
    ...
    <div class="row row-margin row-button">
        <div class="col-xs-6">
            <a href="<?php echo url_for("parcellaire_affectation_parcelles", array('sf_subject' => $parcellaire, 'appellation' => ParcellaireAffectationClient::getInstance()->getFirstAppellation())) ?>" class="btn btn-primary btn-lg btn-upper"><span class="eleganticon arrow_carrot-left"></span>&nbsp;&nbsp;Précédent</a>
        </div>
