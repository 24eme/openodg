...
class parcellaireAffectationActions extends sfActions {
    ...
    public function executeCreate(sfWebRequest $request) {
        ...
        $this->parcellaire = ParcellaireAffectationClient::getInstance()->findOrCreate($etablissement->identifiant, $request->getParameter('campagne', ConfigurationClient::getInstance()->getCampagneManager()->getCurrentNext()));

        $this->parcellaire->initProduitFromLastParcellaire();
        $this->parcellaire->save();

        return $this->redirect('parcellaire_affectation_edit', $this->parcellaire);
    }
    ...
    public function executeEdit(sfWebRequest $request) {
        ...
        if ($parcellaire->exist('etape') && $parcellaire->etape) {
            if ($parcellaire->etape == ParcellaireAffectationEtapes::ETAPE_PARCELLES) {
                $this->redirect('parcellaire_affectation_' . $parcellaire->etape, array('id' => $parcellaire->_id, 'appellation' => ParcellaireAffectationClient::getInstance()->getFirstAppellation($parcellaire->getTypeParcellaire())));
            }
            return $this->redirect('parcellaire_affectation_' . $parcellaire->etape, $parcellaire);
        }

        return $this->redirect('parcellaire_affectation_exploitation', $parcellaire);
    }
    ...
    public function executeExploitation(sfWebRequest $request) {
        ...
        if ($request->getParameter('redirect', null)) {
            return $this->redirect('parcellaire_affectation_validation', $this->parcellaire);
        }

        return $this->redirect('parcellaire_affectation_propriete', $this->parcellaire);
    }
    ...
    public function executePropriete(sfWebRequest $request) {
        ...
        return $this->redirect('parcellaire_affectation_parcelles', array('id' => $this->parcellaire->_id, 'appellation' => $this->firstAppellation));
    }
    ...
    public function executeParcelles(sfWebRequest $request) {
        ...
        $this->ajoutForm = new ParcellaireAffectationAjoutParcelleForm($this->parcellaire);
        ...
        if ($request->isMethod(sfWebRequest::POST)) {
            ...
            if ($this->form->isValid()) {
                ...
                if ($this->appellationNode && $this->appellationNode != ParcellaireAffectationClient::APPELLATION_VTSGN &&
                    ($next_appellation = $next_appellation = $this->appellationNode->getNextAppellationKey()))
                {
                    return $this->redirect('parcellaire_affectation_parcelles', array('id' => $this->parcellaire->_id, 'appellation' => $next_appellation));
                } else {
                    return $this->redirect('parcellaire_affectation_acheteurs', $this->parcellaire);
                }
            }
        }
    }
    ...
    public function executeAjoutParcelle(sfWebRequest $request) {
        ...
        if (!$this->form->isValid()) {
            ...
            return $this->redirect('parcellaire_affectation_parcelles', array('id' => $this->parcellaire->_id, 'appellation' => $this->appellation));
        }
    }
    ...
    public function executeDeleteParcelle(sfWebRequest $request) {
        ...
        return $this->redirect('parcellaire_affectation_parcelles', array('id' => $parcellaire->_id, 'appellation' => $appellation));
    }
    ...
    public function executeValidation(sfWebRequest $request) {
        ...
        if ($this->parcellaire->isPapier()) {
            ...
            return $this->redirect('parcellaire_affectation_visualisation', $this->parcellaire);
        }

        $this->sendParcellaireValidation($this->parcellaire);

        return $this->redirect('parcellaire_affectation_confirmation', $this->parcellaire);
    }
