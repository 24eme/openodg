...
/**
 * Description of ParcellaireAppellationEditForm
 *
 * @author mathurin
 */
class ParcellaireAffectationAppellationEditForm extends acCouchdbObjectForm {
    ...
    public function configure() {
        $this->embedForm('produits', new ParcellaireAffectationAppellationProduitsForm($this->parcelles, $this->appellationKey));
