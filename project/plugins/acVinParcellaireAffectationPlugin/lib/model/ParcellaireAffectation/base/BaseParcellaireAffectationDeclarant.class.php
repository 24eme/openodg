<?php
/**
 * BaseParcellaireAffectationDeclarant
 * 
 * Base model for ParcellaireAffectationDeclarant
...
abstract class BaseParcellaireAffectationDeclarant extends acCouchdbDocumentTree {
                
    public function configureTree() {
       $this->_root_class_name = 'ParcellaireAffectation';
       $this->_tree_class_name = 'ParcellaireAffectationDeclarant';
    }
