<?php
/**
 * BaseParcellaireIntentionAffectationProduitDetail
 * 
 * Base model for ParcellaireIntentionAffectationProduitDetail
...
abstract class BaseParcellaireIntentionAffectationProduitDetail extends acCouchdbDocumentTree {
