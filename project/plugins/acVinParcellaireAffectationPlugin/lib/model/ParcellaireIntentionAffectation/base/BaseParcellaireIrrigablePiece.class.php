<?php
/**
 * BaseParcellaireIntentionAffectationPiece
 *
 * Base model for ParcellaireIntentionAffectationPiece
...
abstract class BaseParcellaireIntentionAffectationPiece extends Piece {

    public function configureTree() {
       $this->_root_class_name = 'ParcellaireIntentionAffectation';
       $this->_tree_class_name = 'ParcellaireIntentionAffectationPiece';
    }
