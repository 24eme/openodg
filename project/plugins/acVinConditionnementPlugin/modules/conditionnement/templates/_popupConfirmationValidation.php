<?php if($approuver): ?>
	<div class="modal fade" id="conditionnement-confirmation-validation" role="dialog" aria-labelledby="Confirmation de validation" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
					...
					<div class="modal-body">
						<p>Confirmez-vous la validation de votre Déclaration de Conditionnement ?</p>
					</div>
