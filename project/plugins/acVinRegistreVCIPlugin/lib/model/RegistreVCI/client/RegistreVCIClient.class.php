...
class RegistreVCIClient extends acCouchdbClient implements FacturableClient {
    ...
    public static function MOUVEMENT_SENS($m) {
      $sens = array(self::MOUVEMENT_CONSTITUE => 1, self::MOUVEMENT_RAFRAICHI => 0, self::MOUVEMENT_COMPLEMENT => -1, self::MOUVEMENT_DESTRUCTION => -1, self::MOUVEMENT_SUBSTITUTION => -1);
      return $sens[$m];
    }
