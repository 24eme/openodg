        ...
        <thead>
            ...
            <tr>
                ...
                <th class="col-xs-1 text-center striped-success small">Usages industriels</th>
                    ...
                    <?php endif ?>
                <?php endif; ?>
                <th class="<?php if ($drev->hasDR()): ?>manual-width small<?php else: ?>col-xs-2<?php endif; ?> text-center">Issus de la récolte<br/><small class="text-muted">(hl)</small><a title="Le volume revendiqué correspond au volume sur place de votre Déclaration de Récolte moins les usages industriels et le vci constitué appliqués à votre exploitation" data-placement="auto" data-toggle="tooltip" class="btn-tooltip btn btn-md pull-right"><span class="glyphicon glyphicon-question-sign"></span></a></th>
                <th class="<?php if ($drev->hasDR()): ?>manual-width small<?php else: ?>col-xs-2<?php endif; ?> text-center">Issus du VCI<br/><small class="text-muted">(hl)</small><a title="Volume issu du VCI de l'année précédente" data-placement="auto" data-toggle="tooltip" class="btn-tooltip btn btn-md pull-right"><span class="glyphicon glyphicon-question-sign"></span></a></th>
