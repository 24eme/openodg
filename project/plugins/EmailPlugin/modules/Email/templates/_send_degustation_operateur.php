...
Un agent de l'ODG-AVA viendra prélever vos lots <?php echo $operateur->libelle ?> du Millésime <?php echo $operateur->getMillesime(); ?> à votre chai situé au <?php echo getAdresseChai($operateur) ?> :
