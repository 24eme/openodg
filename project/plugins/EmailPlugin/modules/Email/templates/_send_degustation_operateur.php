...
Un agent de l'ODG-AVA viendra prélever vos lots <?php echo $operateur->appellation_libelle ?> du Millésime 2014 à votre chai situé au <?php echo getAdresseChai($operateur) ?> :
