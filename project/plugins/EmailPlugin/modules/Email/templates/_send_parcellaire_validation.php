...
Vous pouvez à tout moment revenir sur votre compte pour consulter ou imprimer votre document : <?php echo sfContext::getInstance()->getRouting()->generate('parcellaireaffectation_visualisation', $parcellaire,true); ?>
