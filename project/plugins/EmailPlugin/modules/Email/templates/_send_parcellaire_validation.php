...
Votre déclaration d'<?php echo ($parcellaire->isIntentionCremant())? 'intention de production' : 'affectation parcellaire'; ?><?php echo ($parcellaire->isParcellaireCremant())? ' crémant' : ''; ?> <?php echo $parcellaire->campagne; ?> a bien été validée et envoyée au service Appui technique de l'AVA.
