...
En votre qualité de dégustateur expert <?php echo DegustationClient::getAppellationLibelle($degustation->appellation) ?>, nous vous invitons à venir participer à une dégustation conseil :
