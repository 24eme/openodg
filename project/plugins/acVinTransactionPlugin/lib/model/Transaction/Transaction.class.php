 ...
 *
 */
class Transaction extends BaseTransaction implements InterfaceVersionDocument, InterfaceDeclarantDocument, InterfacePieceDocument, InterfaceMouvementLotsDocument, InterfaceArchivageDocument {
    ...
    public function getLots(){
        ...
        uasort($lots, "Transaction::compareLots");
        return $lots;
    }
  ...
  /*** FIN ARCHIVAGE ***/
    ...
    public function findDocumentByVersion($version) {
        ...
        return TransactionClient::getInstance()->find($id);
    }
