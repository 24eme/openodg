<?php
class TransactionEtapes extends Etapes
{
	...
	public static $links = array(
            self::ETAPE_EXPLOITATION => 'transaction_exploitation',
            self::ETAPE_LOTS => 'transaction_lots',
            self::ETAPE_VALIDATION => 'transaction_validation'
    );
	...
	public static function getInstance()
	{
		if(is_null(self::$_instance)) {
			self::$_instance = new TransactionEtapes();
		}
