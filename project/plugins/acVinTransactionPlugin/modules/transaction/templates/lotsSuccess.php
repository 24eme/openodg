...
<?php include_partial('transaction/step', array('step' => TransactionEtapes::ETAPE_LOTS, 'transaction' => $transaction, 'ajax' => true)) ?>
    ...
    <form role="form" action="<?php echo url_for("transaction_lots", $transaction) ?>" method="post" id="form_transaction_lots" class="form-horizontal">
            ...
            <div class="panel-body" style="padding-bottom: 0;">
              <div class="row">
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      <?php echo $lot['numero_logement_operateur']->renderLabel("N° de logement et destinataire", array('class' => "col-sm-3 control-label")); ?>
                      <div class="col-sm-5">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <?php echo $lot['destination_date']->renderLabel("Date de transaction", array('class' => "col-sm-4 control-label")); ?>
                            <div class="col-sm-5">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                      ...
                      <?php for($i=0; $i < TransactionLotForm::NBCEPAGES; $i++): ?>
    ...
    <div style="margin-top: 20px;" class="row row-margin row-button">
        <div class="col-xs-4">
            <a tabindex="-1" href="<?php echo  url_for('transaction_exploitation', $transaction)  ?>?prec=1" class="btn btn-default btn-upper"><span class="glyphicon glyphicon-chevron-left"></span> Retourner à l'étape précédente</a>
        </div>
