...
<table border="1" class="table" cellspacing=0 cellpadding=0 style="text-align: right;">
    <tr>
        ...
        <th class="th" style="text-align: center; width: 245px">&nbsp;Destination (date)</th>
    </tr>
...
<?php foreach ($lotsByCouleur as $lot) : ?>
    <tr>
        ...
        <td class="td" style="text-align: center;"><?php echo tdStart() ?><?php echo $lot->pays; echo ($lot->destination_date) ? " (".$lot->getDestinationDateFr().")" : ''; ?></td>
    </tr>
<?php endforeach; ?>
<?php endforeach; ?>
</table>
