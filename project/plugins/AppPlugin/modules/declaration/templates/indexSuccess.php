            ...
            <tbody>
                <?php foreach($docs as $doc): ?>
                    <tr>
                        ...
                        <td><a href="<?php echo url_for("declaration_etablissement", array("identifiant" => $doc->key[DeclarationTousView::KEY_IDENTIFIANT], 'campagne' => $doc->key[DeclarationTousView::KEY_CAMPAGNE])); ?>"><?php echo $doc->key[DeclarationTousView::KEY_RAISON_SOCIALE]; ?> <small>(<?php echo $doc->key[DeclarationTousView::KEY_IDENTIFIANT]; ?>)</small></a></td>
