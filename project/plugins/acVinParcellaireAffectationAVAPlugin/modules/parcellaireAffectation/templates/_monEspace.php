<div class="col-sm-6 col-md-4 col-xs-12">
    <div class="block_declaration panel <?php if ($parcellaire && $parcellaire->validation): ?>panel-success<?php else: ?>panel-primary<?php endif; ?>">
        ...
        <h3>Affectation&nbsp;parcellaire&nbsp;<?php echo $periode; ?><br/>&nbsp;</h3>
        </div>
        ...
        <div class="panel-bottom">
                <p>
                    <a class="btn btn-lg btn-block btn-primary" href="<?php echo url_for('parcellaireaffectation_visualisation', $parcellaire) ?>">Visualiser</a>
                </p>
        ...
        <div class="panel-bottom-documents panel-bottom-documents-etape">
            ...
            <div class="panel-bottom">
                <?php if ($sf_user->isAdmin()): ?>
                    <p>
                        <a class="btn btn-lg btn-default btn-block" href="<?php echo url_for('parcellaire_create', array('sf_subject' => $etablissement, 'campagne' => $periode)) ?>">Démarrer la télédéclaration</a>
                    </p>
                    <p>
            ...
            <div class="panel-bottom-documents <?php if(date('Y-m-d') > ParcellaireAffectationConfiguration::getInstance()->getDateOuvertureFin()): ?> panel-bottom-documents-demarrage <?php endif; ?>">
                <a href="<?php echo url_for('pieces_historique', array('sf_subject' => $etablissement, 'categorie' => 'parcellaireaffectation')) ?>" class="btn btn-xs btn-link btn-block">Voir tous les documents</a>
            </div>
            <?php else:  ?>
            <div class="panel-body">
            ...
            <div class="panel-bottom">
                    <p>
                        <a class="btn btn-lg btn-block btn-default" href="<?php echo url_for('parcellaire_create', array('sf_subject' => $etablissement, 'campagne' => $periode)) ?>">Démarrer la télédéclaration</a>
                    </p>
