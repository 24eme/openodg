<?php
/**
 * BaseParcellaireIrrigableDeclarant
 * 
 * Base model for ParcellaireIrrigableDeclarant
...
abstract class BaseParcellaireIrrigableDeclarant extends acCouchdbDocumentTree {
                
    public function configureTree() {
       $this->_root_class_name = 'ParcellaireIrrigable';
       $this->_tree_class_name = 'ParcellaireIrrigableDeclarant';
    }
