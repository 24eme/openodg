...
class acVinCompteRouting {
	...
	$r->prependRoute('compte_removetag', new sfRoute('/compte/search/removetag', array('module' => 'compte', 'action' => 'removetag')));
        ...
        $r->prependRoute('compte_ajout', new SocieteRoute('/compte/:identifiant/nouveau',
                        ...
                        array('model' => 'Societe',
                            'type' => 'object')));
                $r->prependRoute('compte_modification', new CompteRoute('/compte/:id/modification',
                        array('module' => 'compte',
                            'action' => 'modification'),
                        array('sf_method' => array('get', 'post')),
                        array('model' => 'Compte',
                            'type' => 'object')));
        $r->prependRoute('compte_visualisation', new CompteRoute('/compte/:id/visualisation',
                        array('module' => 'compte',
                            'action' => 'visualisation'),
                        array('sf_method' => array('get', 'post')),
                        array('model' => 'Compte',
                            'type' => 'object')));
          $r->prependRoute('compte_switch_statut', new CompteRoute('/compte/:id/switchStatus',
                        array('module' => 'compte',
                            'action' => 'switchStatus'),
                        array('sf_method' => array('get', 'post')),
                        array('model' => 'Compte',
                            'type' => 'object')));
        $r->prependRoute('compte_coordonnee_modification', new CompteRoute('/compte-coordonnee/:id/modification',
                        array('module' => 'compte',
