...
<div class="row">
    <section class="col-xs-9" id="contenu_etape">
        ...
        <div class="input-group">
            ...
            placeholder = "Votre recherche..." autocomplete = "off" data-url = "<?php echo url_for('soc_etb_com_autocomplete_all', array('link' => true, 'interpro_id'=> 'INTERPRO-declaration','type_compte' => '*')); ?>"
