                  ...
                  ?>
                    <tr>
                      ...
                      <?php $params = array("id" => $doc->id); if($regionParam): $params=array_merge($params,array('region' => $regionParam)); endif; ?>
                        ...
                        <td><a href="<?php echo url_for("declaration_doc", $params); ?>"><?php echo clarifieTypeDocumentLibelle($doc->key[DeclarationTousView::KEY_TYPE]); ?><?php if(strpos($doc->id, 'DREV-') && strpos($doc->id, 'M')): ?><br /><small class="text-muted"><?php echo substr($doc->id, strpos($doc->id, 'M')); ?></small><?php endif; ?></a></td>
