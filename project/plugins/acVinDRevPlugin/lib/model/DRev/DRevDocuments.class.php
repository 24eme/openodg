...
class DRevDocuments extends BaseDRevDocuments
{
	...
	private static $_engagement_libelles = array(
        ...
        DRevDocuments::DOC_VIP2C_OUEX_CONDITIONNEMENT => "<strong>J'ai une déclaration de conditionnement,</strong> en revendiquant au-delà de mon Volume Individuel de Production Commercialisable Certifiée (VIP2C) de Méditerranée Rosé, je m'engage à fournir à l'IVSE <strong>ma déclaration de conditionnement</strong> pour les lots de Méditerranée Rosé de cette revendication.",
        DRevDocuments::DOC_VIP2C_OUEX_CONTRAT_VENTE_EN_VRAC => "<strong>J'ai un contrat de commercialisation,</strong> en revendiquant au-delà de mon Volume Individuel de Production Commercialisable Certifiée (VIP2C) de Méditerranée Rosé, je certifie que les lots de cette revendication sont commercialisés via le Contrat n° ",
