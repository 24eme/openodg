...
class DRevDocuments extends BaseDRevDocuments
{
	...
	private static $_engagement_libelles = array(
        ...
        DrevDocuments::DOC_BULLETIN_ANALYSE => "Je m'engage à envoyer par courrier ou par mail le bulletin d'analyse de mes lots concernés par cette déclaration à mon ODG.",
    );
