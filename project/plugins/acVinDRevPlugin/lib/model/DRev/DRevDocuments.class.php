...
class DRevDocuments extends BaseDRevDocuments
{
	...
	private static $_engagement_libelles = array(
        ...
        DRevDocuments::DOC_VIP2C_OUEX_CONDITIONNEMENT => "En revendiquant au-delà de mon Volume Individuel de Production Commercialisable Certifiée (VIP2C) de Méditerranée Rosé, je m'engage à fournir à l'IVSE ma déclaration de conditionnement pour les lots de Méditerranée Rosé de cette revendication.",
