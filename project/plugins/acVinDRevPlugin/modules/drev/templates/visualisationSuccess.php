...
<div class="row row-margin row-button">
    ...
    <div class="col-xs-4 text-right">
        ...
        <?php endif; ?>
        <?php if(!$drev->validation): ?>
                <a href="<?php echo url_for("drev_delete", $drev) ?>" class="btn btn-default alert-danger" onclick="return confirm('Souhaitez-vous vraiment SUPPRIMER ce document ?')"><span class="glyphicon glyphicon-remove"></span> Supprimer cette saisie</a>
