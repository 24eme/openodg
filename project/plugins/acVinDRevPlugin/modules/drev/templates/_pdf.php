...
<table class="table" border="1" cellspacing=0 cellpadding=0 style="text-align: right;">
    ...
    <?php foreach($drev->declaration->getProduitsWithoutLots($region) as $produit): ?>
        <tr>
            <td class="td" style="text-align:left;"><?php echo tdStart() ?>&nbsp;<?php echo $produit->getLibelleComplet() ?><?php if($produit->denomination_complementaire) { echo '&nbsp;'.$produit->denomination_complementaire; } ?>
            </td>
