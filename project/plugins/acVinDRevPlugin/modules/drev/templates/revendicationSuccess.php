...
<?php if ($drev->getDocumentDouanierType() == DRCsvFile::CSV_TYPE_DR): ?>
                ...
                <th class="text-center info col-xs-1" style="position: relative;"><?php if($drev->hasVCIConstitue() && $drev->hasVSI()): ?>Volume VCI constitué (L18)<br /><small>ou VSI (L19)</small><?php elseif($drev->hasVSI()): ?>Volume<br />VSI<br/>(L18)<?php else: ?>Volume VCI constitué<br/>(L19)<?php endif; ?><br/><small class="text-muted">(hl)</small><a title="<?php echo getPointAideText('drev', 'vci_constitue') ?>" data-placement="auto" data-toggle="tooltip" class="btn-tooltip btn btn-md" style="position: absolute  ; bottom: 0; right: 0px;"><span class="glyphicon glyphicon-question-sign"></span></a></th>
