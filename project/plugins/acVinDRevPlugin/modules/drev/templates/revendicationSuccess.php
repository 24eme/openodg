...
<?php if ($drev->getDocumentDouanierType() == DRCsvFile::CSV_TYPE_DR): ?>
                ...
                <th class="text-center info col-xs-1" style="position: relative;"><?php if($drev->hasVCIConstitue() && $drev->hasVSI()): ?>Volume VCI constitué (L18)<br /><small>ou VSI (L19)</small><?php elseif($drev->hasVSI()): ?>Volume<br />VSI<br/>(L18)<?php else: ?>Volume VCI constitué<br/>(L19)<?php endif; ?><br/><small class="text-muted">(hl)</small><a title="<?php if($drev->hasVCIConstitue()): echo getPointAideText('drev', 'vci_constitue'); endif ?> <?php if($drev->hasVSI()): echo getPointAideText('drev', 'vsi'); endif ?>" data-placement="auto" data-toggle="tooltip" class="btn-tooltip btn btn-md" style="position: absolute  ; bottom: 0; right: 0px;"><span class="glyphicon glyphicon-question-sign"></span></a></th>
                ...
                <th class="col-xs-1 text-center" style="position: relative;">Volume d’alcool ajouté<br />pour le mutage<br /><small class="text-muted">(hl)</small><a title="<?php echo getPointAideText('drev', 'volume_revendique_issu_mutage') ?>" data-placement="auto" data-toggle="tooltip" class="btn-tooltip btn btn-md" style="position: absolute; bottom: 0; right: 0px;"><span class="glyphicon glyphicon-question-sign"></span></a></th>
                <?php endif; ?>
                <th class="col-xs-1 text-center" style="position: relative;"><?php if($drev->hasVCIRevendique() && $drev->hasVSI()): ?>Volume revendiqué<br />issu du VCI<br /><small>ou du VSI</small><?php elseif($drev->hasVSI()): ?>Volume revendiqué<br />issu du VSI<?php else: ?>Volume revendiqué<br />issu du VCI<?php endif; ?><br /><small class="text-muted">(hl)</small><a title="<?php if($drev->hasVCIRevendique()): echo getPointAideText('drev', 'volume_revendique_issu_vci'); endif ?> <?php if($drev->hasVSI()): echo getPointAideText('drev', 'volume_revendique_issu_vsi'); endif ?>" data-placement="auto" data-toggle="tooltip" class="btn-tooltip btn btn-md" style="position: absolute; bottom: 0; right: 0px;"><span class="glyphicon glyphicon-question-sign"></span></a></th>
