...
<a tabindex="-1" style="position: absolute; right:<?php echo $pos ?>px; cursor:pointer;"  data-toggle="modal" data-target="#modalSyndicats" title="contacts de vos syndicats">
