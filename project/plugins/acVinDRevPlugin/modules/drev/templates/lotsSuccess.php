            ...
            <div class="modal-dialog">
                <div class="modal-content">
                            ...
                            <div class="form-group ligne_lot_cepage ">
                                ...
                                <div class="col-sm-4">
                                    <div class="input-group input-group-pc" style='display:none;'>
                                        <input class='form-control text-right input-pc'id='<?php echo $lot->renderId() ?>_repartition_pc_<?php echo($i) ?>'></input>
                        ...
                        <div class="form-group ligne_volume_total">
                            ...
                            <div class="col-sm-4">
                                <div class="input-group volume-total">
                                  <input class='form-control text-right input-total' id='<?php echo $lot->renderId() ?>_volume_total'></input>
                                  <div class="input-group-addon">hl</div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="modal-footer">
                        ...
                        <a class="btn btn-success btn pull-right" data-lot="<?php echo $key ?>" data-dismiss="modal">Valider</a>
                    </div>
                </div>
            </div>
        </div>
