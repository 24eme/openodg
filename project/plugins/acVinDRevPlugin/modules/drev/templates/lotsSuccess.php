            ...
            <div class="row">
              ...
              <div class="col-md-1 text-right">
                <?php if($isAdmin && !$lot->id_document_affectation): ?>
                    <a href="<?php echo url_for("drev_lot_delete_master", array('id' => $drev->_id, 'numArchive' => $lot->numero_archive)) ?>" onclick='return confirm("Étes vous sûr de vouloir supprimer ce lot ?");' class="close" title="Supprimer ce lot" aria-hidden="true">×</a>
                <?php elseif($isAdmin): ?>
    ...
    <div style="margin-top: 36px;" class="row row-margin row-button">
        ...
        <div class="col-xs-4 text-center">
            <?php if ($sf_user->hasDrevAdmin() && $drev->getDocumentDouanier()): ?>
              <a href="<?php echo url_for('drev_document_douanier', $drev); ?>" class="btn btn-default pull-left" >
