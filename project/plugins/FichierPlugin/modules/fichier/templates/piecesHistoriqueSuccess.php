            ...
            <?php foreach ($history as $document): ?>
                ...
                <tr>
                    ...
                    <td class="text-right">
                        ...
                        <a style="opacity: 0.3" onclick="navigator.clipboard.writeText(this.href); alert('Le lien a été copié dans le presse papier !'); return false;" title="Lien public pour partage" class="pull-left" href="<?php echo url_for('piece_public_view', array('doc_id' => $document->id, 'piece_id' => $document->value[PieceAllView::VALUES_KEY], 'auth' => UrlSecurity::generateAuthKey($document->id.$document->value[PieceAllView::VALUES_KEY]))) ?>"><span class="glyphicon glyphicon-link"></span></a>
                        <?php endif; ?>
