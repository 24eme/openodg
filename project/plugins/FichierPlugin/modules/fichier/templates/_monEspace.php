        ...
        <div class="panel-heading">
            ...
            <div class="panel-body">
                ...
                <div class="actions">
                    ...
                    <?php elseif(DRConfiguration::getInstance()->hasValidationDR() && $dr->exist('validation') && $dr->validation): ?>
                        <a class="btn btn-block btn-success" href="<?php echo url_for('dr_visualisation', $dr) ?>">
                    ...
                    <?php elseif(DRConfiguration::getInstance()->hasValidationDR()): ?>
                        <a class="btn btn-block btn-default" href="<?php echo url_for('dr_visualisation', $dr) ?>">
                            <span class="glyphicon glyphicon-file"></span> Approuver la DR
                        </a>
                    <?php else: ?>
