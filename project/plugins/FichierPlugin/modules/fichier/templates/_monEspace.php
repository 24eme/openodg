            ...
            <div class="panel-body">
                ...
                <div style="margin-top: 50px; margin-bottom: 26px;">
                  <?php if($sv): ?>
                	...
                	<a class="btn btn-xs btn-default btn-block pull-right" href="<?php echo url_for('scrape_fichier', array('sf_subject' => $etablissement, 'periode' => $periode, 'type' => ($etablissement->famille == EtablissementFamilles::FAMILLE_COOPERATIVE) ? 'SV11' : 'SV12')) ?>"><span class="glyphicon glyphicon-cloud-download"></span>&nbsp;&nbsp;Importer depuis Prodouane</a>
                	<?php endif; ?>
                </div>
            </div>
    </div>
