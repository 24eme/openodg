...
<ol class="breadcrumb">
  ...
  <li class="active"><a href="">Modification d'un document</a></li>
</ol>
...
<form class="form-horizontal" role="form" action="<?php echo url_for("edit_fichier", $fichier) ?>" method="post" novalidate>
    ...
    <div class="row row-margin row-button">
        <div class="col-xs-6">
        	<a href="<?php echo url_for('declaration_etablissement', $etablissement) ?>" class="annuler btn btn-default btn-danger">Retour</a>
        </div>
