...
class FichierDonneeForm extends acCouchdbObjectForm
{
    ...
    public function configure() {
        $this->setWidgets(array(
            ...
            'categorie' => new bsWidgetFormChoice(array('choices' => DouaneCsvFile::getCategories())),
        ...
        $this->setValidators(array(
            ...
            'categorie' => new sfValidatorChoice(array('choices' => array_keys(DouaneCsvFile::getCategories()))),
