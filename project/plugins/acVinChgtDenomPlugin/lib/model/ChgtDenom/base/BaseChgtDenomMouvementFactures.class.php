<?php
/**
 * BaseChgtDenomMouvementFactures
 * 
 * Base model for ChgtDenomMouvementFactures
...
abstract class BaseChgtDenomMouvementFactures extends MouvementFactures {
                
    public function configureTree() {
       $this->_root_class_name = 'ChgtDenom';
       $this->_tree_class_name = 'ChgtDenomMouvementFactures';
    }
