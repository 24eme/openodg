    ...
    <div class="block_declaration panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div style="margin-top: 50px;">
                ...
                <a class="btn btn-xs btn-default btn-block" href="<?php echo url_for('chgtdenom_create_papier', array('sf_subject' => $etablissement, 'campagne' => $campagne)) ?>"><span class="glyphicon glyphicon-file"></span>&nbsp;&nbsp;Saisie papier</a>
                <?php else : ?>
