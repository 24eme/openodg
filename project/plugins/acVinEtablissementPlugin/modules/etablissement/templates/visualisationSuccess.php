                    ...
                    <tbody>
                        <?php foreach($etablissement->getLiaisonsOperateursSorted() as $liaison): ?>
                            <tr>
                                ...
                                <td>
                                <?php $chai = $liaison->getChai()->getDocument(); ?>
                                <?php if($modifiable): ?>
                                    <a href="<?php echo url_for('etablissement_visualisation', array('identifiant' => str_replace("ETABLISSEMENT-", "", $liaison->id_etablissement))) ?>"><?php echo Anonymization::hideIfNeeded($chai->nom); ?></a>
                                <?php else: ?>
                                    <?php echo Anonymization::hideIfNeeded($chai->nom); ?></a>
                                <?php endif; ?>
                                </td>
