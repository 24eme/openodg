...
class FactureLatex extends GenericLatex {
  ...
  private function getFileNameWithoutExtention() {
      ...
      return  preg_replace('/[^0-9a-z_-]/i', '', str_replace(' ', '_', $termFacture.str_replace('/', '-', $this->facture->numero_odg).'_'.$commune.'_'.$nom.'_'.$this->facture->identifiant.'_'.$this->facture->numero_facture.'_'.$this->facture->_rev));
  }
