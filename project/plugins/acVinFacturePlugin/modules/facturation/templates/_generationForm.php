        ...
        <div class="col-xs-12">
          <?php if(isset($form["modele"])): ?>
            <div class="form-group <?php if($form["modele"]->hasError()): ?>has-error<?php endif; ?>">
                ...
                <?php echo $form["modele"]->renderLabel("Type de génération", array("class" => "col-xs-3 control-label")); ?>
                <div class="col-xs-9">
          ...
          <?php endif; ?>
            ...
            <div class="form-group <?php if($form["date_mouvement"]->hasError()): ?>has-error<?php endif; ?>">
                ...
                <?php echo $form["date_mouvement"]->renderLabel("Date de mouvements", array("class" => "col-xs-3 control-label")); ?>
                <div class="col-xs-3">
                    <div class="input-group date-picker-week">
            ...
            <div class="form-group <?php if($form["message_communication"]->hasError()): ?>has-error<?php endif; ?>">
                ...
                <?php echo $form["message_communication"]->renderLabel("Message de communication", array("class" => "col-xs-3 control-label")); ?>
                <div class="col-xs-3">
                    <div class="">
            ...
            <div class="form-group <?php if($form["type_document"]->hasError()): ?>has-error<?php endif; ?>">
                ...
                <?php echo $form["type_document"]->renderLabel("Type de document", array("class" => "col-xs-3 control-label")); ?>
                <div class="col-xs-3">
                    <div class="">
