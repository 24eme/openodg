...
- Votre facture "<?php echo $facture->getTemplate()->libelle ?>" : <?php echo url_for('piece_public_view', array('doc_id' => $facture->_id, 'auth' => UrlSecurity::generateAuthKey($facture->_id)), true) ?>
