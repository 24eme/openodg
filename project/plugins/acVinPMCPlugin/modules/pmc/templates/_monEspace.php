...
<div class="col-sm-6 col-md-4 col-xs-12">
    <div class="block_declaration panel <?php if ($pmc && $pmc->validation): ?>panel-success<?php elseif($pmc): ?>panel-primary<?php else : ?>panel-default<?php endif; ?>">
        ...
        <?php elseif ($pmc): ?>
            <div class="panel-body">
                <p class="explications">Reprendre la déclaration de mise en circulation du <?php echo DateTimeImmutable::createFromFormat('Y-m-d H:i:s', $pmc->getDate())->format('d/m/Y'); ?>.</p>
                <div class="actions">
