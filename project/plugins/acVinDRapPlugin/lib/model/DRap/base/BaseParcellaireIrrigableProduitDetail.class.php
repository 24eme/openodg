<?php
/**
 * BaseDRapProduitDetail
 *
 * Base model for DRapProduitDetail
...
abstract class BaseDRapProduitDetail extends DeclarationParcellaireParcelle {

    public function configureTree() {
       $this->_root_class_name = 'DRap';
       $this->_tree_class_name = 'DRapProduitDetail';
    }
