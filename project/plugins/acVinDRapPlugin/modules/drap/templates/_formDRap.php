        ...
        <tr class="vertical-center" id="tr_<?php echo $parcelle->getParcelleId();?>">
            ...
            <td class="text-center">
                <div style="margin-bottom: 0;" class="form-group">
                    <div class="col-xs-12">
                        <a <?php if(!$parcelle->exist('materiel') || !$parcelle->materiel || !$parcelle->ressource): ?> style="opacity:0.6;" <?php endif; ?>
                            ...
                            class="btn btn-sm btn-default duplicateBtn <?php if(!$parcelle->exist('materiel')  || !$parcelle->materiel || !$parcelle->ressource): ?> inactif<?php endif; ?>" data-target="tr_<?php echo $parcelle->getParcelleId();?>" ><span class="glyphicon glyphicon-arrow-down"></span></a>
                    </div>
                </div>
            </td>
        </tr>
